...
| 4  | Built infrastructure | Open Buildings | infrastructure, human impact  | access the dataset from [GEE](https://developers.google.com/earth-engine/datasets/catalog/GOOGLE_Research_open-buildings_v3_polygons), [Source.coop](https://beta.source.coop/repositories/vida/google-microsoft-open-buildings/description/), [OSM via Overpass](https://overpass-turbo.eu/s/1In5)|
