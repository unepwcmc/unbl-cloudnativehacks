...
| ------------- | ------------- | ------------- | ------------- | 
|  0  | Country Boundaries | <sub>to report at national level or to aggregate stats by country. ([see the map on UNBL](https://map.unbiodiversitylab.org/earth?basemap=grayscale&coordinates=20,0,2&layers=wdpa-protected-areas_100))</sub> | <sub>+ [UNBL Azure Blob]() <br/>+ [Planetary Computer]() <br/>+ [GEE/EarthBlox](https://gee-community-catalog.org/projects/bii/)|</sub>|
