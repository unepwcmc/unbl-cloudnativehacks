...
| #  | Dataset | How this data could be useful | Cloud Native Data | Other Format | 
| ------------- | ------------- | ------------- | ------------- | ------------- |
|  0  | Country Boundaries | to report at national level. To aggregate data by country. | [UNBL Azure Blob]() <br/>[MS Planetary Computer]() <br/>[GEE/EarthBlox](https://gee-community-catalog.org/projects/bii/)| |
