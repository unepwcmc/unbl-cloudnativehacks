...
| #  | Dataset | Type | How this data could be useful | Cloud Native Data Access | 
| ------------- | ------------- | ------------- | ------------- | ------------- | 
| 8  | Forest Structural Integrity Index | <sub>raster</sub> | <sub>to assess forest health and biodiversity potential by analyzing structural complexity, human impact, and links to ecosystem services.</sub> | <sub>+ [UNBL Blob](https://cloudnativehacks.blob.core.windows.net/data/08_forest-structural-integrity-index/) </sub> |
